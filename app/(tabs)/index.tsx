...
export default function HomeScreen() {
    ...
    const refreshProducts = async () => {
        try {
            let _items = await AsyncStorage.getItem(
                "@expiredproducts_products"
            );
            if (_items == null) {
                _items = "[]";
            }
            ...
            items.forEach((item, key) => {
                ...
                const expiredDateDifference = Math.round(
        ...
        >
            {isUpdateAvailable && (
                ...
                >
                    <Text style={{ fontWeight: "bold", textAlign: "center" }}>
                        Télécharger et mettre à jour l'application
                    </Text>
                </Pressable>
            )}
            <View
            ...
            >
                ...
                >
                    ...
                    >
                        <View
                            style={[styles.filter_dot, styles.filter_dot__none]}
                        >
                            <></>
                        </View>
                        <Text>Périmé</Text>
                    ...
                    >
                        <View
                            style={[styles.filter_dot, styles.filter_dot__info]}
                        >
                            <></>
                        </View>
                        <Text>{"<"} 15 jours</Text>
                    ...
                    >
                        <View
                            style={[styles.filter_dot, styles.filter_dot__ok]}
                        >
                            <></>
                        </View>
                        <Text>{">"} 15 jours</Text>
